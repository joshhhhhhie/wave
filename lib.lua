local AUTH_TOKEN = "WAVE_9921_XQZ_8832_L9P_0123_KJ"
if getgenv().WAVE_AUTH_TOKEN ~= AUTH_TOKEN then
    return nil
end
...
c('deps.init', function(require, n, c, d)
    ...
    function o._generateSelectionImageObject()
        ...
        q.Transparency = o._config.SelectionImageObjectBorderTransparency or 0
    ...
    function o._cycle()
        ...
        if o.parentInstance:IsA('GuiBase2d') and math.min(o.parentInstance.AbsoluteSize.X, o.parentInstance.AbsoluteSize.Y) < 100 then
            error('Iris Parent Instance is too small')
        end

        local D = o.parentInstance:IsA('GuiBase2d') or o.parentInstance:IsA('CoreGui') or o.parentInstance:IsA('PluginGui') or o.parentInstance:IsA('PlayerGui')
    ...
    function o.Append(a8)
        ...
        if o._config.Parent then
            ...
            a5 = o._widgets[a3.type].ChildAdded(a3, {
                type = 'userInstance',
            })
        end
    ...
    return function(o)
        ...
        local ae = {
            ...
            Tree = function()
                ...
                o.Tree({
                    ...
                    [o.Args.Tree.SpanAvailWidth] = true,
                })
                o.End()
                ...
                o.Checkbox({
                    ...
                    isChecked = af.state.isUncollapsed,
                })
                o.End()
            end,
            Group = function()
            ...
            InputNum = function()
                ...
                local ag, ah, ai, aj, ak, al = o.State(false), o.State(false), o.State(0), o.State(100), o.State(1), o.State('%d')
                local am = o.InputNum({
                    'Input Number',
                ...
                o.Text({
                    string.format('The Value is: %d', am.number.value),
                })
            ...
            InputText = function()
                ...
                local an = o.InputText({
                    'Input Text Test',
                    [o.Args.InputText.TextHint] = 'Input Text here',
                })

                o.PopConfig()
                o.Text({
                    string.format('The text is: %s', an.text.value),
                })
                o.End()
            end,
        }
        ...
        local function ar(as)
            o.Window({
                ...
                size = o.State(Vector2.new(150, 100)),
                isOpened = as,
            })
        ...
        local function au()
            ...
            o.Window({
                ...
                size = o.State(Vector2.new(600, 300)),
                isOpened = aa,
            })
            o.Text({
                'information of Iris Widgets.',
            })
            o.Table({
                1,
                [o.Args.Table.RowBg] = false,
            })
            o.NextColumn()
            o.Tree({
                '\nIris.Text\n',
                [o.Args.Tree.NoIndent] = true,
                [o.Args.Tree.SpanAvailWidth] = true,
            })
            av({
                {
        ...
        local function ax()
            ...
            o.Text({
                string.format('Average %.3f ms/frame (%.1f FPS)', aB.value * 1000, 1 / aB.value),
            })
            o.Text({
                string.format('Window Position: (%d, %d), Window Size: (%d, %d)', ay.position.value.X, ay.position.value.Y, ay.size.value.X, ay.size.value.Y),
            })
            o.PushConfig({
                ItemWidth = UDim.new(0.5, 100),
            })

            local aF = o.InputText({
            ...
            if aG then
                ...
                o.Text({
                    string.format('The ID, "%s", is a widget', aF),
                })
                o.NextRow()
                o.Text({
                    string.format('Widget is type: %s', aG.type),
                })
                o.NextRow()
                o.Tree({
                    'Widget has Args:',
                }, {
                    isUncollapsed = o.State(true),
                })
            ...
            elseif aH then
                ...
                o.Text({
                    string.format('The ID, "%s", is a state', aF),
                })
                o.NextRow()
                o.Text({
                    string.format('Value is type: %s, Value = %s', typeof(aH.value), tostring(aH.value)),
                })
                o.NextRow()
                o.Tree({
                ...
                o.NextRow()
                o.Text({
                    string.format('state has: %d connected functions', #aH.ConnectedFunctions),
                })
                o.End()
            else
                o.Text({
                    string.format('The ID, "%s", is not a state or widget', aF),
                })
            end
            ...
            if o.Tree({
                ...
                o.Text({
                    string.format('Number of Widgets: %d', aI),
                })
                o.Text({aJ})
            end
            ...
            if o.Tree({
                ...
                o.Text({
                    string.format('Number of States: %d', aK),
                })
                o.Text({aL})
            end
        ...
        do
            ...
            local function aP(j)
                o.PushConfig({
                    ContentWidth = UDim.new(0, 100 - o._config.ItemInnerSpacing.X),
                })
                o.SameLine()

                local aQ = o.InputNum({
                    '',
                    [o.Args.InputNum.NoButtons] = true,
                    [o.Args.InputNum.Format] = '%d',
                }, {
                    number = aN[j .. 'X'],
                })
                local aR = o.InputNum({
                ...
                if aQ.numberChanged or aR.numberChanged then
                    o.UpdateGlobalConfig({
                        [j] = Vector2.new(aQ.number.value, aR.number.value),
                    })
                end
            ...
            local function aS(j)
                ...
                if aT.numberChanged or aU.numberChanged then
                    o.UpdateGlobalConfig({
                        [j] = UDim.new(aT.number.value, aU.number.value),
                    })
                end
            ...
            local function aV(j, aW)
                o.PushConfig({
                    ContentWidth = UDim.new(0, 50 - o._config.ItemInnerSpacing.X),
                })
                o.SameLine()
            ...
            local b8 = {
                ...
                },
                {
                    ...
                    function()
                        ...
                        aV('TitleBgColor', 'TitleBgTransparency')
        ...
        local function ba()
            ...
            o.Text({
                string.format('The Number is: %d', bb:get()),
            })
            ...
            o.Text({
                string.format('Text Timer: %d', bc:get()),
            })
            o.End()
        end
        local function bd()
        ...
        local function bp()
            ...
            o.Text({
                string.format('Hue: %d', math.floor(bq:get() * 255)),
            })
            o.End()
            o.PushConfig({
                TextColor = Color3.fromHSV(bq:get(), 1, 1),
            })
            o.Text({
        ...
        return function()
            ...
            o.Window({
                ...
                size = o.State(Vector2.new(600, 550)),
                position = o.State(Vector2.new(100, 25)),
            })
            o.Text{
                'Iris says hello!',
            }
    ...
    return function(o)
        ...
        local function c2(c3, c4, c5, c6)
            ...
            c3.InputBegan:Connect(function(c8)
                if not (c8.UserInputType == Enum.UserInputType.MouseButton1 or c8.UserInputType == Enum.UserInputType.Gamepad1) then
                    return
                end
                if c6 == 'Text' then
            ...
            c3.InputEnded:Connect(function(c8)
                if not (c8.UserInputType == Enum.UserInputType.MouseButton1 or c8.UserInputType == Enum.UserInputType.Gamepad1) or c7 then
                    return
                end
        ...
        local function c9(c1, ca)
            ...
            if cd > 0 and cf > 0 then
                ...
                q.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
                q.LineJoinMode = Enum.LineJoinMode.Round
                q.Transparency = o._config.ButtonTransparency
                q.Thickness = cd
                q.Color = ce
            ...
            o.WidgetConstructor('Table', false, true, {
                ...
                Update = function(L)
                    ...
                    if L.arguments.RowBg == false then
                        ...
                        for c_, B in L.CellInstances do
                            ...
                            B.BackgroundTransparency = d0 % 2 == 0 and o._config.TableRowBgAltTransparency or o._config.TableRowBgTransparency
                        end
                    end
                ...
                ChildAdded = function(L)
                    ...
                    if L.arguments.RowBg ~= false then
                        ...
                        local d6 = d0 % 2 == 0 and o._config.TableRowBgAltTransparency or o._config.TableRowBgTransparency
        ...
        do
            ...
            local function dz(L, dA)
                ...
                return Vector2.new(math.clamp(dA.X, o._config.WindowBorderSize, math.max(o._config.WindowBorderSize, dx.X - cW.WindowButton.AbsoluteSize.X - o._config.WindowBorderSize)), math.clamp(dA.Y, o._config.WindowBorderSize, math.max(o._config.WindowBorderSize, dx.Y - cW.WindowButton.AbsoluteSize.Y - o._config.WindowBorderSize)))
            end
            ...
            bI.InputBegan:Connect(function(c8, dD)
                ...
                if c8.KeyCode == Enum.KeyCode.Tab and (bI:IsKeyDown(Enum.KeyCode.LeftControl) or bI:IsKeyDown(Enum.KeyCode.RightControl)) then
                    dp()
                end
                if c8.UserInputType == Enum.UserInputType.MouseButton1 then
            ...
            bI.InputChanged:Connect(function(c8)
                ...
                if dc then
                    ...
                    local dA = dL + Vector2.new(dg == Enum.LeftRight.Left and dM.X or 0, df == Enum.TopBottom.Top and dM.Y or 0)
                    local dN = dv + Vector2.new(dg == Enum.LeftRight.Left and -dM.X or dg == Enum.LeftRight.Right and dM.X or 0, df == Enum.TopBottom.Top and -dM.Y or df == Enum.TopBottom.Bottom and dM.Y or 0)
                    local dO = dt(db, dN)
                    local dP = dz(db, dA)
            ...
            bI.InputEnded:Connect(function(c8, dD)
                if (c8.UserInputType == Enum.UserInputType.MouseButton1 or c8.UserInputType == Enum.UserInputType.Touch) and d9 then
                    local dI = d8.Instance.WindowButton
                ...
                if (c8.UserInputType == Enum.UserInputType.MouseButton1 or c8.UserInputType == Enum.UserInputType.Touch) and dc then
                    dc = false
            ...
            o.WidgetConstructor('Window', true, true, {
                ...
                Generate = function(L)
                    ...
                    dR.InputBegan:Connect(function(c8)
                        if c8.UserInputType == Enum.UserInputType.MouseMovement or c8.UserInputType == Enum.UserInputType.Keyboard then
                            return
                        end
                ...
                GenerateState = function(L)
                    ...
                    if L.state.position == nil then
                        L.state.position = o._widgetState(L, 'position', dj and di.state.position.value + Vector2.new(15, 45) or Vector2.new(150, 250))
                    end
...
c('deps.config', function(require, n, c, d)
    local eb = {
        ...
        colorCyan = {
            ...
            TextDisabledColor = Color3.fromRGB(128, 128, 128),
            TextDisabledTransparency = 0,
            BorderColor = Color3.fromRGB(0, 180, 180),
            BorderActiveColor = Color3.fromRGB(0, 255, 255),
            BorderTransparency = 0,
            BorderActiveTransparency = 0,
            WindowBgColor = Color3.fromRGB(25, 25, 25),
            WindowBgTransparency = 0.05,
            ScrollbarGrabColor = Color3.fromRGB(0, 255, 255),
            ScrollbarGrabTransparency = 0.5,
            TitleBgColor = Color3.fromRGB(20, 20, 20),
            TitleBgTransparency = 0,
            TitleBgActiveColor = Color3.fromRGB(0, 80, 80),
            TitleBgActiveTransparency = 0,
            TitleBgCollapsedColor = Color3.fromRGB(0, 0, 0),
            TitleBgCollapsedTransparency = 0.5,
            FrameBgColor = Color3.fromRGB(0, 80, 80),
            FrameBgTransparency = 0.46,
            FrameBgHoveredColor = Color3.fromRGB(0, 200, 200),
            FrameBgHoveredTransparency = 0.46,
            FrameBgActiveColor = Color3.fromRGB(0, 255, 255),
            FrameBgActiveTransparency = 0.33,
            ButtonColor = Color3.fromRGB(0, 150, 150),
            ButtonTransparency = 0.4,
            ButtonHoveredColor = Color3.fromRGB(0, 200, 200),
            ButtonHoveredTransparency = 0.2,
            ButtonActiveColor = Color3.fromRGB(0, 255, 255),
            ButtonActiveTransparency = 0,
            HeaderColor = Color3.fromRGB(0, 150, 150),
            HeaderTransparency = 0.31,
            HeaderHoveredColor = Color3.fromRGB(0, 200, 200),
            HeaderHoveredTransparency = 0.2,
            HeaderActiveColor = Color3.fromRGB(0, 255, 255),
            HeaderActiveTransparency = 0,
            SelectionImageObjectColor = Color3.fromRGB(0, 255, 255),
            SelectionImageObjectTransparency = 0.8,
            SelectionImageObjectBorderColor = Color3.fromRGB(0, 255, 255),
            SelectionImageObjectBorderTransparency = 0,
            TableBorderStrongColor = Color3.fromRGB(0, 180, 180),
            TableBorderStrongTransparency = 0,
            TableBorderLightColor = Color3.fromRGB(0, 150, 150),
            TableBorderLightTransparency = 0,
            TableRowBgColor = Color3.fromRGB(0, 0, 0),
            TableRowBgTransparency = 1,
            TableRowBgAltColor = Color3.fromRGB(0, 80, 80),
            TableRowBgAltTransparency = 0.94,
            NavWindowingHighlightColor = Color3.fromRGB(0, 255, 255),
            NavWindowingHighlightTransparency = 0.3,
            NavWindowingDimBgColor = Color3.fromRGB(0, 50, 50),
            NavWindowingDimBgTransparency = 0.65,
            SeparatorColor = Color3.fromRGB(0, 255, 255),
            SeparatorTransparency = 0.5,
            CheckMarkColor = Color3.fromRGB(0, 255, 255),
            CheckMarkTransparency = 0,
        },
        sizeDefault = {
        ...
        sizeMobile = {
            ...
            WindowResizePadding = Vector2.new(10, 10),
            FramePadding = Vector2.new(12, 10),
            ItemSpacing = Vector2.new(12, 10),
            ItemInnerSpacing = Vector2.new(10, 10),
            CellPadding = Vector2.new(8, 6),
            IndentSpacing = 30,
            TextFont = Enum.Font.Code,
            TextSize = 18,
            FrameBorderSize = 1,
